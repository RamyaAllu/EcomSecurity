...
//      model.addAttribute("products", products);
	...
	public String categoriesView(Model model,@PathVariable("id") int catagoryId)
	{
		...
		List<PhysicalCategory> catagorylist=PhysicalCategoryServices.getAllCatagory();
		model.addAttribute("catagorylist", catagorylist);
		List<PhysicalSubCategory> subcatagorylist=PhysicalSubCategoryServices.findPhysicalSubCategoryByCatagory(catagoryId);
		model.addAttribute("subcatagorylist", subcatagorylist);
	...
	List<PhysicalProducts> products = physicalProductService.findProductsBySubcategories(subcatagoryId);
	      model.addAttribute("products", products);
